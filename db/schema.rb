...
ActiveRecord::Schema.define(version: 20170321233629) do
  ...
  create_table "card_ratings", force: :cascade do |t|
    ...
    t.index ["card_id"], name: "index_card_ratings_on_card_id", using: :btree
    t.index ["user_id"], name: "index_card_ratings_on_user_id", using: :btree
  end
  ...
  create_table "taggings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["deck_id", "tag_id"], name: "index_taggings_on_deck_id_and_tag_id", unique: true, using: :btree
  end
